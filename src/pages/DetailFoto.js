    ...
    <>
      ...
      <Container>
        <SectionWrapper>
          ...
          />
          <Description>
            During my work with Stu Shapiro in Cape Town we arranged fashion
            shoots for models to top upgrade their portfolios.
          </Description>
        </SectionWrapper>
        <SectionWrapper>
          <SliderDetail
          ...
          />
          <Description>
            These pictures were taken during a project at KISD. Using light
            painting we protested against the housing and gentrification
            problems in major German cities.
          </Description>
        </SectionWrapper>
        <SectionWrapper>
          <SliderDetail
        ...
        <SectionWrapper>
          ...
          <Description>
            ...
            their head or not.. These pictures document our journey.
          </Description>
        </SectionWrapper>
        <SectionWrapper>
          <SliderDetail
